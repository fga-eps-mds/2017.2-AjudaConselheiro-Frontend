...
export class ChecklistoneComponent implements OnInit {
  ...
  checkSecTwo: CheckQuestion[] = [
    ...
    new CheckQuestion('A ventilação e circulação de ar são adequadas e capazes de garantir o '
      + 'conforte térmico e o ambiente livre de sujidades'),
    ...
    new CheckQuestion('Lavatórios em condições de higiene, dotados de sabonete líquido inodoro antiséptico, '
    + 'toalhas de papel não reciclado ou outro sistema higiênico e seguro de secagem e coletorde papel acionados sem contato manual'),
    new CheckQuestion('Existência de lavatórios na área de manipulação com água corrente, '
    + 'em posições adequadas em relação ao fluxo de produção e serviço e em número suficiente de modo a atender toda a área de produção'),
    ];
   checkSecThree: CheckQuestion[] = [
      new CheckQuestion('Reservatório de água e encanamentos acessíveis, dotados de tampas, '
      + 'em satifatóriacondição de uso, livre de vazamentos, infiltrações e descasccamentos'),
   ...
   checkSecSix: CheckQuestion[] = [
      ...
      new CheckQuestion('Os alimentos preparaddos, que serão congelados ou refrigerados, '
      + 'são adeqquadamente acondicionados e identificados com: nome da preparação, '
      + 'data de preparo e prazo de validade após a abertura ou retirada da embalagem original'),
