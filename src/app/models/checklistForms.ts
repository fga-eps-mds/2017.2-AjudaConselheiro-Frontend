...
export const FormMenuThree: Array<SectionCommentaryTwo> = [
  {question: 'O cantineiro tem conhecimento da Lei n.º5.146/2013?'},
  {question: 'O cantineiro tem conhecimento do Decreto n.º36.900/2015'},
  {question: 'O cantineiro já recebeu a visita da vigilância sanitária para a fiscalização?'},
  {question: 'Os funcionários possuem curso de boas práticas de manipulação de alimentos?'},
  {question: 'Os atestados de saúde ocupacional estão em dia e de fácil acesso?'},
];
