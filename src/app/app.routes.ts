...
export const ROUTES: Routes = [
  ...
  { path: 'checklist/1/:id', component: ChecklistoneComponent},
  { path: 'checklist/menu/:id', component: ChecklistMenuComponent},
  { path: 'checklist/3/:id', component: ChecklistthreeComponent},
  ...
  { path: 'checklist/todas', component: ChecklistListComponent },
];
